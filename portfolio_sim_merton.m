...
%% call options
[merton_call_returns, merton_call_prices, merton_call_strikes, merton_call_stds] = ... 
    all_eu(merton_stocks, num_options, @price_call, @call_returns, ...
    rate, T, nTrials);

%% put options
[merton_put_returns, merton_put_prices, merton_put_strikes, merton_put_stds] = ... 
    all_eu(merton_stocks, num_options, @price_put, @put_returns, ...
    rate, T, nTrials);

%% Amp options
[merton_amp_returns, merton_amp_prices, merton_amp_stds] = all_lookbacks(merton_stocks, ...
    rate, T, @price_lookback, @amplitude_payoff);

%% final max options
[merton_max_returns, merton_max_prices, merton_max_stds] = all_lookbacks(merton_stocks, ...
    rate, T, @price_lookback, @final_max_payoff);

%% min final options
[merton_min_returns, merton_min_prices, merton_min_stds] = all_lookbacks(merton_stocks, ...
